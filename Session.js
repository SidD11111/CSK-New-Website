class Session extends React.Component {
  ...
  render() {
    ...
    openChild = reminder;
    var title = e("h3", null, [
      `${this.props.Display} Session ${this.props.Time}`,
      openChild,
    ]);

    var calendar = e(Calendar, { dates: this.props.Dates });
    var calendarContainer = e(
      "div",
      {
        style: {
    ...
    var input = e("input", {
      ...
      className: "primary",
      value: "Register your child!",
      onClick: () => (window.location.href = "http://parents.compscikids.net/"),
    });
    children.push(input);
